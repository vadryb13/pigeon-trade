...
| # | Файл | Что показывает |
|---|---|---|
| 01 | [`01_explore_empty.html`](01_explore_empty.html) | Empty state — пустой лист после первого деплоя. Два CTA: `+ New hypothesis` и `AI: suggest first idea`. Без templates (по решению команды). |
